...
import DataIntegrator from '../models/service/DataIntegratorModel.js';

// Middleware to check authentication
export const authenticateTokenClient = async (req, res, next) => {
...
// Middleware to check authentication
export const authenticateRefreshTokenClient = async (req, res, next) => {
