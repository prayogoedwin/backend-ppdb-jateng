...
import { getSekolahTujuan, getSekolahTujuanPublik, getSekolahTujuanJurusanPublik, getSekolahTujuanKabkota } from "../controllers/master/SekolahTujuan.js";
...
import { cekPerangkingan, createPerangkingan, getPerangkingan, uploadFileTambahan, cetakBuktiPerangkingan, cetakBuktiPerangkinganAdmin, getPerangkinganSaya, softDeletePerangkingan, daftarUlangPerangkingan, getPerangkinganDetail, getInfoParam } from '../controllers/service/Perangkingan.js';
...
router.post('/api/servis/revisi_data', csrfProtection, ipWhitelistMiddleware, appKeyMiddleware, verifyRecaptcha, logAccess, updatePendaftarByUser);
...
router.post('/api/servis/aktivasi_akun', csrfProtection, ipWhitelistMiddleware, appKeyMiddleware, verifyRecaptcha, logAccess, aktivasiAkunPendaftar);
router.post('/api/servis/data_dukung', csrfProtection, ipWhitelistMiddleware, appKeyMiddleware, verifyRecaptcha, getDataDukungByNIK);
...
router.post('/api/auth/login', csrfProtection, ipWhitelistMiddleware, appKeyMiddleware, verifyRecaptcha, logAccess, loginUser);
...
router.post('/api/auth/lupa_password', csrfProtection, ipWhitelistMiddleware, appKeyMiddleware, verifyRecaptcha, forgotPassword);
