...
//Service
import { getPesertaDidikByNisnHandler, getDataDukungByNIK, getPesertaDidikByNisnNamaNamaNamaIbuHandler, getPesertaDidikByNisnTokHendler } from '../controllers/service/PesertaDidik.js';
...
router.post('/admin-api/oriental-servi/cek_zonasi_by_kec', csrfProtection, ipWhitelistMiddleware, appKeyMiddleware, cekZonasiByKecamatan);
router.post('/admin-api/oriental-servi/cek_zonasi_khusus_by_kec', csrfProtection, ipWhitelistMiddleware, appKeyMiddleware, cekZonasiKhususByKecamatan);
