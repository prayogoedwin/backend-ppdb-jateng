...
PerangkinganModels.belongsTo(DataPendaftars, { as: 'data_pendaftar_byid', foreignKey: 'id_pendaftar' });
PerangkinganModels.belongsTo(DataPendaftars, { as: 'data_pendaftar', foreignKey: 'nisn', targetKey: 'nisn' });
