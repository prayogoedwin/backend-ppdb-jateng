...
export const getPerangkinganSaya = async (req, res) => {
    try {
        ...
        const resData = await DataPerangkingans.findAll({
            ...
            group: ['DataPerangkingans.id', 'sekolah_tujuan.npsn', 'sekolah_tujuan.nama', 'sekolah_jurusan.id', 'sekolah_jurusan.nama_jurusan', 'jalur_pendaftaran.bentuk_pendidikan_id', 'jalur_pendaftaran.nama'], // Kelompokkan berdasarkan id
            order: [['id', 'ASC']],
            include: [
                {
                    model: SekolahTujuan,
