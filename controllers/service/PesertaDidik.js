    ...
    try {
        ...
        if (cekPendaftar) {
            ...
            if(cekPendaftar.is_verified == 98){
                ...
                //ini revisi biasa + buka alamat dan domisili
                ...
                return res.status(200).json({
                    status: 3,
                    message: 'NISN diperbolehkan untuk revisi data alamat dan wilayah sementara',
                    data: data
                });
            ...
            if(cekPendaftar.is_verified == 99){
                ...
                return res.status(200).json({
                    status: 99,
                    message: 'NISN diperbolehkan untuk update data kebutuhan force majeure',
                    data: data
                });
